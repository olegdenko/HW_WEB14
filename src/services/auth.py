...
class Auth:
    ...
    def verify_password(self, plain_password, hashed_password):
        ...
        :param hashed_password: Compare the hashed password from the database with a plain text password that is entered by a user
        :return: True if the password matches, otherwise it returns false
        :doc-author: Trelent
        """
    ...
    async def create_access_token(
        ...
        :return: A jwt encoded with the following claims:
        :doc-author: Trelent
        """
        to_encode = data.copy()
        if expires_delta:
